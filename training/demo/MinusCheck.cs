...
//   但页面上那条**横向分隔线**会被当成负号量。随机抽 3,970 张蓝图实测:
//     · **8 张**被量出了 bar_width(约 **1/500**)
//     · 这 8 张的 bar_width 是 **8.45 ~ 10.52**(正常是 0.70) —— **8/8 全部会判成 Suspicious**
//     · 数字高 69~116, **60 px 那道闸一张都拦不住**
//   蓝图池 12 万张量级, 折合**两三百张金额被无故清空**。
//   **这一版开头就把蓝图整个跳掉。**
//
