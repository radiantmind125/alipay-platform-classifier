...
namespace Ssp
{
    ...
    public static class MinusCheck
    {
        ...
        static bool IsMerchantPage(Mat gray)
        {
            ...
            // ★ 带宽实测定下来的。按图标长宽比分桶看 3,499 张被闸掉的图:
            //     0.85~0.97   501 张   负号报警  0.4%   bar 中位 0.7075  <- 详情页行为
            //     0.97~0.99   155 张             39.4%            0.7297
            //     0.99~1.01 1,604 张             87.6%            1.0238  <- 真正的叉号页
            //     1.01~1.03   239 张             38.9%            0.7209
            //     1.03~1.07   336 张             14.6%            0.7021
            //     1.07~1.15   663 张              2.0%            0.7111  <- 详情页行为
            //   对照详情页 697,528 张 报警 0.13% bar 中位 0.7045。
            //   两端那批已经调原图看过, 全是普通详情页(顶部有通知横幅或状态栏图标,
            //   角上那块被误认成关闭图标), 数值和真图无法区分。
            //   收窄到 0.97~1.03 后覆盖代价从 0.50% 降到 0.28%, 负号报出 13.29 -> 14.18/万。
            return ar >= 0.97 && ar <= 1.03;      // 近正方形 = X 关闭图标
        }
