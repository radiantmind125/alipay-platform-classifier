...
def main() -> None:
    ...
    print("\n判读(★ 原版取的是能量**最大**的块 —— 见 patch_select 文件头):")
    print("  两边纯色块都接近 0、能量中位相近 -> **取块对上了**")
    print("  '我选的更简单'大致五五开        -> 对上了。两边都是从各自 64 个随机块里取最大,")
    print("                                     抽样不同, 高低互见才正常")
    print("  一边倒(比如 16/16)             -> **方向或候选集不对**, 别往下做")
    print("  我这边纯色块明显更多            -> 又取成最小了(犯过一次, 分数会系统性偏高 0.16)")
